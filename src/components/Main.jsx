  ...
  return (
    <>
      <div className='py-[2rem]'>
        ...
        <p className='text-center font-Roboto font-normal mt-[.1rem] mb-[1rem] text-Black dark:text-White transition-colors'>
          DF is a restaurant, bar, and cafe located in Canada.
        </p>
        <a href='#' className='w-max block font-Roboto font-medium mx-auto border-b-[.1rem] text-Black border-dashed border-Black py-[.1rem] px-[.5rem] dark:text-White dark:border-White transition-colors'>
          ORDER NOW
        </a>
      </div>
      <section className='my-[1rem] sm:grid sm:grid-flow-col items-center sm:gap-3'>
        <div>
          <p className='font-Roboto font-semibold text-Black dark:text-White transition-colors'>WHY US</p>
          ...
          <p className='font-Roboto text-Black mt-[1rem] dark:text-White transition-colors'>
            Our company was founded in 1982 and our goal is to last forever and bring happiness into your life.
          </p>
          <a href='#' className='w-max block font-Roboto font-medium mx-auto border-b-[.1rem] text-Black border-dashed border-Black py-[.1rem] px-[.5rem] dark:text-White dark:border-White transition-colors mt-[4rem] sm:mt-[1rem] sm:mx-0'>
            OUT STORY
          </a>
        </div>
      ...
      <section className='my-[1rem]'>
        <p className='font-Roboto font-semibold text-Black dark:text-White transition-colors'>EXPLORE</p>
        <h2 className='font-Roboto font-bold mb-[1rem] text-[1.25rem] text-Black dark:text-White transition-colors'>
          MENU FEATURES
        </h2>
        ...
        <a href='#' className='w-max block font-Roboto font-medium mx-auto border-b-[.1rem] text-Black border-dashed border-Black py-[.1rem] px-[.5rem] dark:text-White dark:border-White transition-colors mt-[1.5rem]'>
          SEE MENU
        </a>
      </section>
      <section className='my-[1rem]'>
