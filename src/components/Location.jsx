...
export const Location = () => {
  ...
  return (
    <article className='mt-[3rem] px-[2rem] py-[1.5rem] border-[.1rem] border-Black border-dashed dark:border-White transition-colors max-w-sm mx-auto' data-aos='fade-up' data-aos-duration='1000' data-aos-delay='800'>
      <h2 className='font-Roboto font-bold text-center text-Black dark:text-White transition-colors md:text-lg'>FIND US</h2>
      <h3 className='font-Roboto text-[1.25rem] font-bold text-center text-Black dark:text-White transition-colors md:text-[1.35rem]'>OUR ADDRESS</h3>
